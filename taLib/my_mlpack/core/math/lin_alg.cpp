 ...
 * eigenvalues.
 */
void ta::math::VectorPower(arma::vec& vec, double power)
{
 ...
 */
void ta::math::Center(const arma::mat& x, arma::mat& xCentered)
{
 ...
 * matrix.
 */
void ta::math::WhitenUsingSVD(const arma::mat& x,
                                  arma::mat& xWhitened,
 ...
 */
void ta::math::WhitenUsingEig(const arma::mat& x,
                                  arma::mat& xWhitened,
                                  arma::mat& whiteningMatrix)
{
 ...
 */
void ta::math::RandVector(arma::vec& v)
{
  v.zeros();
 ...
 */
void ta::math::Orthogonalize(const arma::mat& x, arma::mat& W)
{
 ...
 * implementation.
 */
void ta::math::Orthogonalize(arma::mat& x)
{
  Orthogonalize(x, x);
}
 ...
 */
void ta::math::RemoveRows(const arma::mat& input,
