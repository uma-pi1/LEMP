 ...
 * eigenvalues.
 */
void mips::math::VectorPower(arma::vec& vec, double power)
{
 ...
 */
void mips::math::Center(const arma::mat& x, arma::mat& xCentered)
{
 ...
 * matrix.
 */
void mips::math::WhitenUsingSVD(const arma::mat& x,
                                  arma::mat& xWhitened,
 ...
 */
void mips::math::WhitenUsingEig(const arma::mat& x,
                                  arma::mat& xWhitened,
                                  arma::mat& whiteningMatrix)
{
 ...
 */
void mips::math::RandVector(arma::vec& v)
{
  v.zeros();
 ...
 */
void mips::math::Orthogonalize(const arma::mat& x, arma::mat& W)
{
 ...
 * implementation.
 */
void mips::math::Orthogonalize(arma::mat& x)
{
  Orthogonalize(x, x);
}
 ...
 */
void mips::math::RemoveRows(const arma::mat& input,
