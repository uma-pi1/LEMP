 ...
 */
#ifndef __MY_MLPACK_CORE_UTIL_CLI_HPP
#define __MY_MLPACK_CORE_UTIL_CLI_HPP
 ...
 *     new paragraphs).
 */
#define PROGRAM_INFO(NAME, DESC) static mips::util::ProgramDoc \
    io_programdoc_dummy_object = mips::util::ProgramDoc(NAME, DESC);
 ...
 */
#ifdef __COUNTER__
  #define PARAM(T, ID, DESC, ALIAS, DEF, REQ) static mips::util::Option<T> \
  ...
  #define PARAM_FLAG_INTERNAL(ID, DESC, ALIAS) static \
      mips::util::Option<bool> JOIN(__io_option_flag_object_, __COUNTER__) \
      (ID, DESC, ALIAS);
  /** @endcond */
  ...
  /** @cond Don't document internal macros. */
  #define PARAM_FLAG_INTERNAL(ID, DESC, ALIAS) static \
      mips::util::Option<bool> JOIN(__io_option_flag_object_, __LINE__) \
      (ID, DESC, ALIAS);
  /** @endcond */
