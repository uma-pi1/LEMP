 ...
 */
#ifndef __MY_MLPACK_CORE_UTIL_VERSION_HPP
#define __MY_MLPACK_CORE_UTIL_VERSION_HPP

#include <string>

// The version of mlpack.  If this is svn trunk, this will be a version with
// higher number than the most recent release.
#define __MY_MLPACK_VERSION_MAJOR 1
#define __MY_MLPACK_VERSION_MINOR 0
#define __MY_MLPACK_VERSION_PATCH 8
