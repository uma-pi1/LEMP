 ...
 */
#include <mips/my_mlpack/core/tree/mrkd_statistic.hpp>

using namespace mips;
using namespace mips::tree;
...
std::string MRKDStatistic::ToString() const
{
  ...
  if (leftStat != NULL)
  {
    ...
    convert << mips::util::Indent(leftStat->ToString());
  }
  if (rightStat != NULL)
  {
    convert << "rightStat:" << std::endl;
    convert << mips::util::Indent(rightStat->ToString());
  }
  return convert.str();
}
